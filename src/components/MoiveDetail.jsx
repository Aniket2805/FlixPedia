    ...
    <>
      <div className="w-[100%] relative flex flex-col items-center">
        <div className="lg:w-[80%]">
          <img
            className="w-[100%] lg:h-[600px] object-cover object-[0,35%]"
        ...
        <div className="flex items-center w-[90%] lg:w-[75%] relative bottom-[120px] min-[380px]:bottom-[130px] min-[440px]:bottom-[160px] min-[540px]:bottom-[180px] sm:bottom-[220px] md:bottom-[270px]">
          <div className="mr-[30px] w-[40%] min-[450px]:w-[35%] sm:w-[30%]">
            <div>
              <img
                className="rounded-xl shadow-[0px_22px_40px_6px_rgba(0,0,0,0.86)]"
          ...
          <div className="flex flex-col justify-between w-[60%] min-[450px]:w-[65%] sm:w-[70%]">
            <div className="text-white text-sm sm:text-base md:text-lg">
              <div className="mb-1 sm:mb-3 drop-shadow-[0px_0px_5px_#000000] text-yellow-300 font-bold text-base min-[440px]:text-xl sm:text-2xl md:text-4xl lg:text-6xl">
                {movieData?.original_title}
              </div>
              <div className="mb-1 sm:mb-2 drop-shadow-[0px_0px_5px_#000000]">
                {movieData?.tagline}
              </div>
              ...
              <div className="mb-1 sm:mb-2 drop-shadow-[0px_0px_5px_#000000] my-5 flex justify-start gap-2 flex-wrap">
                {movieData?.genres?.map((genre) => {
                  return (
                    <span
                      key={genre?.id}
                      className="px-2 py-1 rounded-[20px] border-solid border-2 border-white bg-black/40 text-white/90"
                    >
                      {genre?.name}
                    </span>
                  );
            ...
            <div className="my-8 text-[15px] md:text-lg hidden sm:flex sm:flex-col">
              <div className="text-xl md:text-2xl mb-5 font-semibold flex relative items-center">
                Synopsis
              </div>
        ...
        <div className="relative bottom-[90px] sm:bottom-[120px] flex flex-col sm:flex-row justify-center sm:justify-between w-[90%] lg:w-[75%]">
          <div className="text-2xl flex items-center mb-5 sm:mb-0 md:text-4xl font-medium text-black/90 justify-center sm:justify-start">
            Useful Links
          </div>
          <div className="flex flex-col justify-center min-[333px]:flex-row min-[333px]:justify-between sm:gap-2">
            {movieData?.homepage && (
              <a href={movieData.homepage} target="_blank">
                <p className="flex justify-center">
                  <span className="flex justify-center items-center py-[8px] md:py-[12px] px-3 rounded-[20px] w-[150px] font-bold bg-blue-700 text-white max-[333px]:mb-4">
                    Homepage<FiExternalLink className="ml-3"></FiExternalLink>
                  </span>
                </p>
              </a>
            )}
            {movieData?.imdb_id && (
              ...
              >
                <p className="flex justify-center">
                  <span className="flex justify-center items-center py-[8px] md:py-[12px] px-6 rounded-[20px] w-[150px] font-bold bg-yellow-700 text-white">
                    IMDB<FiExternalLink className="ml-6"></FiExternalLink>
                  </span>
                </p>
              </a>
            )}
        ...
        <div className="text-3xl text-center sm:text-4xl font-semibold">
      ...
      <div>
        <div className="grow overflow-y-auto text-white px-10 py-10 sm:px-20 mt-8 sm:py-20">
          <h1 className="font-extrabold text-black/90 text-2xl md:text-3xl lg:text-5xl text-center pb-14">
            Similar Movies
          </h1>
